...
export const prospects: Prospect[] = [
  { id: '1', companyName: 'Brio Water Technology', contacts: parseContacts(''), state: '', type: 'OEM', marketType: 'Water Coolers', stage: '', lastContact: '1/23', engagementNotes: 'Water coolers', linkedIn: 'https://www.linkedin.com/company/briowatertech/people/', engagements: generateEngagements('Water coolers', '1/23') },
  { id: '2', companyName: 'Glacier Fresh / WaterH', contacts: parseContacts(''), state: 'NJ', type: 'OEM', marketType: 'Water Filtration', stage: '', lastContact: '1/23', engagementNotes: 'WaterH is parent company', linkedIn: 'https://www.linkedin.com/company/glacier-fresh/people/', engagements: generateEngagements('WaterH is parent company', '1/23') },
  { id: '3', companyName: 'Aquatru', contacts: parseContacts(''), state: 'CA', type: 'OEM', marketType: 'Water Filtration', stage: '', lastContact: '1/23', engagementNotes: 'Ideal Living is parent company', linkedIn: 'https://www.linkedin.com/company/aquatru', engagements: generateEngagements('Ideal Living is parent company', '1/23') },
