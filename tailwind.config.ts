    ...
    extend: {
      colors: {
        ...
        stage: {
          ...
          "new-foreground": "hsl(var(--stage-new-foreground))",
          contact: "hsl(var(--stage-contact))",
          "contact-foreground": "hsl(var(--stage-contact-foreground))",
          quotes: "hsl(var(--stage-quotes))",
          "quotes-foreground": "hsl(var(--stage-quotes-foreground))",
          ...
          purchase: "hsl(var(--stage-purchase))",
          "purchase-foreground": "hsl(var(--stage-purchase-foreground))",
          repeat: "hsl(var(--stage-repeat))",
          "repeat-foreground": "hsl(var(--stage-repeat-foreground))",
          maintenance: "hsl(var(--stage-maintenance))",
          "maintenance-foreground": "hsl(var(--stage-maintenance-foreground))",
        ...
        type: {
          ...
          "oem-foreground": "hsl(var(--type-oem-foreground))",
          distributor: "hsl(var(--type-distributor))",
          "distributor-foreground": "hsl(var(--type-distributor-foreground))",
          ecommerce: "hsl(var(--type-ecommerce))",
          "ecommerce-foreground": "hsl(var(--type-ecommerce-foreground))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
