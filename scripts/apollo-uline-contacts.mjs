#!/usr/bin/env node
/**
 * Enrich U-Line Corp contacts via Apollo people/match by known email,
 * then save to the U-Line prospect in Supabase CRM.
 *
 * Emails confirmed by prior Gmail outreach (Nov–Jan 2026).
 * Usage: node scripts/apollo-uline-contacts.mjs
 */
...
// Known contacts confirmed by Gmail sent outreach
const KNOWN_CONTACTS = [
  { email: 'david.seifert@u-line.com',   firstName: 'David' },
  { email: 'carl.floyd@u-line.com',      firstName: 'Carl' },
  { email: 'michael.gilioli@u-line.com', firstName: 'Michael' },
];
...
// --- Main ---
console.log('\nStep 1: Enriching U-Line contacts via Apollo people/match...\n');
