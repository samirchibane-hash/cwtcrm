#!/usr/bin/env node
/**
 * Create Gmail drafts for Rideau Supply contacts using WQA intro template.
 * Usage: node scripts/draft-rideau-wqa.mjs
 */
...
// Contacts to email — excluding HR (Sue Tuer) and Sales (Rick Pettit)
const TARGETS = [
  { to: 'enafziger@rideausupply.com', name: 'Earl'    },
  { to: 'amulder@rideausupply.com',   name: 'Archie'  },
  { to: 'jhughes@rideausupply.com',   name: 'John'    },
  { to: 'nroney@rideausupply.com',    name: 'Norman'  },
  { to: 'jobrien@rideausupply.com',   name: 'Jon'     },
  { to: 'draymond@rideausupply.com',  name: 'Derek'   },
  { to: 'tvignola@rideausupply.com',  name: 'Tracy'   },
  { to: 'gsmith@rideausupply.com',    name: 'Greg'    },
];

const SUBJECT    = 'LED UVs at the WQA in Miami';
const COMPANY    = 'Rideau Supply';
