#!/usr/bin/env node
/**
 * Create Gmail drafts for the 4 new Haws Co contacts using WQA intro template.
 * Usage: node scripts/draft-hawsco-wqa.mjs
 */
...
const TARGETS = [
  // Original 7 — last contacted Jan 2026
  { to: 'dominicg@hawsco.com',  name: 'Dominic'  },
  { to: 'chuckg@hawsco.com',    name: 'Chuck'    },
  { to: 'johnu@hawsco.com',     name: 'John'     },
  { to: 'masonb@hawsco.com',    name: 'Mason'    },
  { to: 'dylann@hawsco.com',    name: 'Dylan'    },
  { to: 'johnavong@hawsco.com', name: 'Johnavon' },
  { to: 'josephp@hawsco.com',   name: 'Joseph'   },
];
...
const HOOK       = `Several water fountain OEMs now prefer our LED based UV-C systems because they are compact, long-lasting, and don't affect water temperatures.`;
