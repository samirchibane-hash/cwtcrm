#!/usr/bin/env node
/**
 * Create Gmail drafts for U-Line Corp contacts using WQA intro template.
 * Usage: node scripts/draft-uline-wqa.mjs
 */
...
const TARGETS = [
  { to: 'david.seifert@u-line.com',   name: 'David'   },
  { to: 'carl.floyd@u-line.com',      name: 'Carl'    },
  { to: 'michael.gilioli@u-line.com', name: 'Michael' },
  { to: 'charles.ross@u-line.com',    name: 'Ross'    },
  { to: 'john.lesniak@u-line.com',    name: 'John'    },
  { to: 'mike.olson@u-line.com',      name: 'Mike'    },
  { to: 'maria.sosa@u-line.com',      name: 'Maria'   },
  { to: 'dedric.johnson@u-line.com',  name: 'Dedric'  },
];

const SUBJECT    = 'LED UVs at the WQA in Miami';
const COMPANY    = 'U-Line';
const DRIVE_LINK = 'https://drive.google.com/drive/folders/1Pb8pPqPLei7VxoSe3FWT7IQZ93-dnT3q?usp=sharing';
const HOOK       = `Several ice machine OEMs now prefer our LED based UV-C systems because they are compact, long-lasting, and don't affect water temperatures.`;
